...
define b = Character("Bruno", color="#93e436")
define c = Character("Clayton", color="#4363e4")
...
label start:
    ...
    label player_name:
        ...
        $ jogador = renpy.input(prompt="What is your name?", allow="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", length=10)

        menu player_name_confirm1:
            "Are you sure your name is [jogador]?"
            "Yes":
                jump player_name_confirm2
            "No":
                jump player_name

        menu player_name_confirm2:
            "Is this what you really want, [jogador]?"
            "Yes...":
                jump player_name_confirm3
            "No...":
                jump player_name

        menu player_name_confirm3:
            "[jogador], is that your final answer?"
            "YES":
                jump first_costumer
            "NO":
                jump player_name
    ...
    b "Oh! The first customer of the day has arrived"
    ...
    menu _1c_First_Choice:
        "What should Bruno say?"
        "\"Good Morning!\"":
            b "Good morning! Welcome to my bakery! How can I help you today?"
            un "Hi!"
            un "Could I get two double shots, please? To go."
            b "Sure thing! Coming right up."
            un "Oh! And do you have bread with scrambled eggs?"
            b "Yes, we do! I'll get that for you as well."
            un "Great! Thank you so much."
            b "My pleasure! Could you just tell me your name?"
            c "It's Clayton"
            b "Such a nice name!"
            c "Thanks!"
            b "Alright, Clayton, your order will be ready in just a moment."
            jump _1c_First_Choice_1a

        "\"It's hot today, isn't it?\"":
            b "It's hot today, isn't it?"
            un "Hmm, yeah...kind of."
    ...
    label _1c_Common_End:
        n "While you prepare the order, Clayton looks around the bakery."
        n "He seems nervous and keep tapping his foot."

        if gentleness >= 1:
            b "Is everything alright, Clayton? You seem a bit nervous."
            c "Oh, um, yeah. I'm just... I'll visit my grandson today."
            b "That's wonderful! Grandchildren are such a blessing."
            c "Yeah... It's been a while since I last saw him. Ten years, actually."
            b "Wow, ten years is a long time. I'm sure your grandson will be thrilled to see you."
            ...
            b "I'm sorry to hear that. Maybe this visit will be a chance to reconnect."
            c "I hope so..."
            c "Anyways, thanks for being so kind."
            b "Of course! Here's your order, Clayton."
            c "Thanks a lot."
            n "Clayton takes his order with a small smile and leaves the bakery, looking more hopeful than before."

            b "That was an interesting encounter. Hope everything goes well for him."

        else:
            b "Here's your order."
            c "Thanks."
            n "Clayton quickly takes his order and leaves the bakery without another word."
    ...
    label _2c_entry:
        ...
        b "Another customer! Time to get back to work."
        ...
        un "H-hello! Could I get a C-Cueca Virada, please."
        b "What's your name?"
            ...
            "\"Such a nice name!\"":
                ...
                menu kidCandyChoice:
                    "Give him candy as change":
                        b "Alright, I'll give you some candy as change this time."
                    ...
                    "No candy change":
                        b "As I said, we don't do that here. Here's your change in cash."
                        n "The kid looks disappointed but accepts the cash."
                        $ dedication += 1
                        jump kidOrderPreparation_B

                #ta fudido esse bagui, dps da uma olhada
                ...
                label kidOrderPreparation_A:
                    ...
                    b "Here you go! Enjoy your Cueca Virada and juice box!"
                    j "Th-thank you so much!"
                    n "The kid takes his order happily and leaves the bakery, waving goodbye."
                    #jump 

                    b "That was a nice interaction. It's always great to see kids enjoying their treats."
    ...
    b "I pity him. Kids can be so cruel to each other at school."

    b "I'm sure he suffers bullying at school with this stutter."
    ...
    label after_2c:
        if gentleness >= 2:
            menu:
                "What should Bruno do now?"
                "Take a break":
                    b "I think it's time for a short break."
                    ...
                    b "Well, hello there, little one! Are you lost? Do you want some food?"
                    ...
                    b "It probably belongs to someone nearby. I should put up a notice."
                    ...
                    b "Stay there while I finish my shift, okay?"
                    $ gentleness += 1
                    $ catInteraction = True

                
                "Prepare for the next customer":
                    b "Better get things ready for the next customer."
                    n "You tidy up the counter and prepare for the next customer."
                    $ dedication += 1

                "Water plants":
                    b "The plants could use some water."
    ...
    label thrid_customer_entry:
        ...
        n "Dings the doorbell again"
        b "Another customer! Let's see who it is this time."
        ...
        menu _3c_Choice:
            ...
            "Trying to get to know my customers better":
                b "Just trying to get to know my customers better! It's nice to meet you, Lúcia."
                l "Nice to meet you too!"
                b "Actually... this is top secreat information..."
                n "You lower your voice conspirationally, take a look around and lean closer to Lúcia."
                b "I was supposed to call clients by their names when their order is ready."
                b "But as the bakery is still new, and as there aren't many customers yet it would be awkward to call out names all the time. Hahaha."
                l "Hahaha, I understand. No worries! Your secret is safe with me."
                n "You both look at each other and share a laugh."
                b "I'll get your order ready right away"
                $ gentleness += 1
                
                menu _3c_Choice_a:
                    "Compliment her tote bag":
                        b "By the way, I love your tote bag! The floral pattern is so pretty."
                        l "Thank you! I got it from a local artisan market. I'm glad you like it."
                        b "It's always nice to support local artists."
                        $ gentleness += 1
            ...
            "Just for my records":
                b "Just for my records."
                l "Oh, okay."

                menu:
                    "Comment on her tote bag":
                        b "That's a nice tote bag you have there."
        ...
        if gentleness > 7:
            ...
            b "Thank you, Lúcia! I really appreciate that."
            ...
            b "Yes, I do! It's been a dream of mine to run my own bakery since I was little."
            b "I remember baking with my mother and helping her sell treats in the street early in the day."
            b "Her only goal back then was to provide for our family, but she inspired me to pursue my passion for baking."
            l "Well, you're doing an amazing job. This place is amazing!"
            b "That means a lot to me. Thank you for your support!"

        if gentleness > 5 and watered_plants==True:
            l "DId you water this plants earlier? They look really healthy and vibrant!"
            b "Yeah, Thanks! I try to take good care of them. A little greenery goes a long way in making the bakery feel welcoming."
            ...
            b "That's wonderful to hear! I appreciate your support."
...
label _3c_endA:
    ...
    b "Here you go! Enjoy your coffee and tapioca!"
    l "Thank you so much!"
    n "Lúcia takes her order happily and leaves the bakery, waving goodbye."

    b "That was a pleasant interaction. I hope she enjoys her order."
    jump after_3c
...
label after_3c:
    ...
    if catInteraction == False and gentleness >=3:
        menu:
            ...
            "Prepare for the next customer":
                ...
                b "Haha, this Lúcia is truly something. That's so nice of her! I should give her a call sometime."
                $ dedication += 1
            ...
            "Do some stretches":
                        b "My back is a bit sore. I should do some stretches."
    ...
    elif wateredPlants == False & dedication >=3:
        menu:
            "What should Bruno do now?"
            "Prepare for the next customer":
                        b "Better get things ready for the next customer."
